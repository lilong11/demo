					...
					<div class="order-details-wrapper">
						<h2>地址信息</h2>
								...
								<div class="order-details fix">
									<ul>
										<li>
											<p class="strong">选择收货地址</p>
											
										</li>
										@foreach($address as $k3=>$v3)
										<li>
											
											<form action="/address/show" method="post">
												{{ csrf_field() }}
...
<!-- =========================添加收货地址弹窗  开始================================ -->
				<li>
					<button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">添加收货地址</button>
									...
									<!-- =============城市联动  开始================ -->	
											          ...
											          <div class="form-group">
											            ...
											            <div class="form-group">
											            <select id="province" name="shen" onchange="changeSelect(this);">
														<option value="" style="color:#999;" disabled="disabled" >-请选择省-</option>
														</select>
														<select id="city" name="shi" onchange="changeSelect(this);">
														<option value="" style="color:#999;" disabled="disabled" >-请选择市-</option>
														</select>
														<select id="district" name="qu">
														<option value="" style="color:#999;" disabled="disabled">-请选区-</option>
														</select>
														</div>
									...
									<!-- ===============城市联动  结束============== -->
											          ...
											          <div class="form-group">
											            ...
											            <textarea class="form-control" id="message-text" name="addr_info"></textarea>
											          </div>
						...
						<form action="/address/pay" method="post">
							...
							<ul>
								...
								<li>
									...
									<p class="last-child strong float-right" style="width:120px;color:orange">
										¥{{ $total }}
									</p>
								</li>
								<li>
...
<style type="text/css">
	select{ width:186px; text-align:center;}
</style>
			...
			if(id=="province"&&element.value!="000000"){
				...
				if(pCode!=0){
					for(var i=0;i<cities.length;i++){
						...
						if(Math.floor(cities[i].ProvinceCode()/10000)==Math.floor(pCode/10000)){
							var op=document.createElement("option");
				...
				if(cCode!=0){
					for(var i=0;i<districts.length;i++){
						...
						if(Math.floor(districts[i].CityCode()/100)==Math.floor(cCode/100)){
							var op=document.createElement("option");
