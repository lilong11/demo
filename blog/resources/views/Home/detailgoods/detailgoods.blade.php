...
============================================ -->
<div class="suggested-product-area padding-90">
	<div class="container">
		<div class="row">
			<!-- Section Title -->
			<div class="section-title col-xs-12 text-center"><h1>SUGGESTED products</h1></div>
			<div class="col-xs-12">
				<!-- Product Slider -->
				<div class="product-slider suggested-slider owl-carousel owl-theme owl-loaded">
					<!-- Single Product -->
				...
				<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1200px, 0px, 0px); transition: 0s; width: 3900px;"><div class="owl-item cloned" style="width: 270px; margin-right: 30px;"><div class="sin-pro">
						<!-- Product Image -->
					...
					</div></div><div class="owl-item cloned" style="width: 270px; margin-right: 30px;"><div class="sin-pro">
						<!-- Product Image -->
						<div class="sin-pro-img-action fix">
					...
					</div></div><div class="owl-item active" style="width: 270px; margin-right: 30px;"><div class="sin-pro">
						<!-- Product Image -->
						<div class="sin-pro-img-action fix">
					...
					</div></div><div class="owl-item" style="width: 270px; margin-right: 30px;"><div class="sin-pro">
						<!-- Product Image -->
						<div class="sin-pro-img-action fix">
							<a href="#" class="sin-pro-img"><img src="img/product/3.jpg" alt=""></a>
							<span class="pro-label label-new">new</span>
					...
					</div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style=""><i class="zmdi zmdi-chevron-left"></i></div><div class="owl-next" style=""><i class="zmdi zmdi-chevron-right"></i></div></div><div class="owl-dots" style="display: none;"></div></div></div>
			</div>
		</div>
	</div>
</div>
