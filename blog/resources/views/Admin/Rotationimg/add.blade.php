...
<!-- 中部开始 -->
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="/rotationimg/store" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="sname" value="{{ old('sname') }}" required="" lay-verify="nikename"
