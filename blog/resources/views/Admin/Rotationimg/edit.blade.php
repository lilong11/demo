          ...
          <div id="side-nav">
            <ul id="nav">
                ...
                <li class="list" >
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="./Admin_public/category.html">
                                <i class="iconfont">&#xe6a7;</i>
                                分类列表
                            </a>
                        </li>
...
<!-- 中部开始 -->
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="/rotationimg/edit" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" value="{{ $rotationimg_data->sid }}" name="sid">
                <div class="layui-form-item">
                    <label for="L_username" class="layui-form-label">
                        <span class="x-red">*</span>商品名称
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" name="sname" value="{{ $rotationimg_data->sname }}" required="" lay-verify="nikename"
