...
<!-- 中部开始 -->
    <div class="wrapper">
        ...
        <div class="page-content">
          <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="/type/store" method="post">
                {{ csrf_field() }}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="tname" value="{{ old('tname') }}" required="" lay-verify="nikename"
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">商品分类</label>
                        <div class="layui-input-inline">
                        <select name="pid" value="{{ old('pid') }}">
                          <option value="0">请选择类型</option>
                          @foreach($type_data as $k=>$v)
                          		<option value="{{ $v->id }}" @if($id == $v->id) selected @endif>{{ $v->tname }}</option>
                          @endforeach
                        <!--   <optgroup label="电脑">
                            <option value="0">戴尔</option>
